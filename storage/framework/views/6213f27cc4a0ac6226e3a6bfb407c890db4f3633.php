...
<?php $__env->startSection('content'); ?>
 ...
 <button type="button" class="btn btn-primary event-entry-icon">
    ...
    <div class="event-entry-form" style="display: none;">
        <form method="POST" class="d-block ajaxForm" action="<?php echo e(route('events.store')); ?>">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\school_managment\School-Mangment-System\resources\views/pages/support_team/dashboard.blade.php ENDPATH**/ ?>